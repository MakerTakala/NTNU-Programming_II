/**
* \file example.c
* \brief height light the keyword of code
* \version 1.0
*
* An program that can highlighter the keyword. Excute the program with "./hw0403 [OPTION] [FILE]" Options are as follows:
...
/**
 * \var linenum recode linenum option
 * \var color recode color option
 * \var language recode language option
 * \var language_name recode the input language param
 */
bool linenum = false, color = false, language = false;
char language_name[128] = {0};

/**
 * @brief read option form argc and argv
 * 
 * @param argc the argc from command option
 * @param argv the argv from command option
 */
...
/**
 * @brief count the number of line of a file
 * 
...
/**
 * @brief compare the cur_word with the keyword database
 * 
 * @param type the type of language
 * @param keyword_len the size of keyword data in type language
 * @param cur_word the string of the word we want to compare
 * 
 * @return true there's a keyword in keyword database
 * @return false there's not keyword in keyword database
 */
